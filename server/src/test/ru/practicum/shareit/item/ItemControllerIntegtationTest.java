...
class ItemControllerIntegtationTest {
    ...
    @SneakyThrows
    void updateItem() {
        Mockito.doThrow(NotOwnerException.class)
                .when(itemService)
    ...
    void getItemById() {
        ...
        mvc.perform(get("/items/{itemId}", 1)
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.nextBooking.id",
                        Matchers.is(itemWithCommentsOutputDto.getNextBooking().getId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.nextBooking.bookerId",
                        Matchers.is(itemWithCommentsOutputDto.getNextBooking().getBookerId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastBooking.id",
                        Matchers.is(itemWithCommentsOutputDto.getLastBooking().getId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.lastBooking.bookerId",
                        Matchers.is(itemWithCommentsOutputDto.getLastBooking().getBookerId()), Long.class));
    ...
    void getAllOwnersItems() {
        ...
        mvc.perform(get("/items")
                ...
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].nextBooking.id",
                        Matchers.is(itemWithCommentsOutputDto.getNextBooking().getId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].nextBooking.bookerId",
                        Matchers.is(itemWithCommentsOutputDto.getNextBooking().getBookerId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].lastBooking.id",
                        Matchers.is(itemWithCommentsOutputDto.getLastBooking().getId()), Long.class))
                .andExpect(MockMvcResultMatchers.jsonPath("$.[0].lastBooking.bookerId",
                        Matchers.is(itemWithCommentsOutputDto.getLastBooking().getBookerId()), Long.class));
